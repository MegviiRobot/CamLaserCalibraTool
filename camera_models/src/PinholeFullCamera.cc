...
PinholeFullCamera::Parameters::Parameters(const std::string &cameraName, //
                                          int w, int h, double k1, double k2,
...
bool PinholeFullCamera::Parameters::readFromYamlFile(
...
void PinholeFullCamera::Parameters::writeToYamlFile(
    const std::string &filename) const
{
  ...
  fs << "{"
     << "k1" << m_k1 << "k2" << m_k2 << "k3" << m_k3 << "k4" << m_k4 << "k5"
     << m_k5 << "k6" << m_k6 << "p1" << m_p1 << "p2" << m_p2 << "}";
...
Camera::ModelType PinholeFullCamera::modelType(void) const
{
  return mParameters.modelType();
}

const std::string &PinholeFullCamera::cameraName(void) const
{
  return mParameters.cameraName();
}

int PinholeFullCamera::imageWidth(void) const
{
...
std::vector<double> PinholeFullCamera::getK(void)
{
  std::vector<double> K;
...
void PinholeFullCamera::readParameters(
...
void PinholeFullCamera::writeParameters(
